<template>
    <div class="document-card">
        ...
        <div class="document-card__footer">
            <p>{{ creationDate }}</p>
            <button v-if="showOpenButton" @click.stop="openItem">
              Открыть
...
import DocumentCommentView from '@/shared/components/documents/document-comment-view/DocumentCommentView.vue';
