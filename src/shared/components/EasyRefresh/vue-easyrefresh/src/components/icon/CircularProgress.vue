      ...
      <div class="circleProgress_wrapper" :class="size">
        <div class="wrapper right" :class="size">
          <div
            ...
            :class="size"
            :style="
              'transform: rotate(' + rightRotate + 'deg);' + 'border-top-color: ' + color + ';' + 'border-right-color: ' + color + ';'
            "
          ></div>
        </div>
        <div class="wrapper left" :class="size">
          <div
            ...
            :class="size"
            :style="
              'transform: rotate(' + leftRotate + 'deg);' + 'border-bottom-color: ' + color + ';' + 'border-left-color: ' + color + ';'
            "
          ></div>
        </div>
      </div>
